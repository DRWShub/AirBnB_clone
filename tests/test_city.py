...
# import sys module
import sys
#tell interpreter where to lool
sys.path.insert(1,"..")
...
class TestCity(unittest.TestCase):
    ...
    def test_city_attr_type(self):
        """Checking City attributes value type"""
        city = City()
    ...
    def test_city_updated_at_matches_created_at_initialization(self):
        """Checking City updated_at is in sync with create_at"""
        city = City()
        self.assertEqual(city.updated_at, city.created_at)

    def test_city_str_method(self):
        """Testing String Methods in City"""
        city = City()
    ...
    def test_city_to_dict_method(self):
        """Checking City for dict key values"""
        city = City()
    ...
    def test_city_dict_to_instance_with_kwargs(self):
        """Checking City can instantiate new object with dictionary"""
        city = City()
        city.name = "Betty"
        city.number = 972
        city_dict = city.to_dict()
    ...
    def test_city_dict_to_instance_with_empty_kwargs(self):
        """Checking City can instantiate new object with empty dict"""
        city_dict = {}
        new_city = City(**city_dict)
        new_city_dict = new_city.to_dict()
